...
using System.Linq;
using System.Text;
using EF = DesignExplorer.Model;

namespace DesignExplorer.DataAccess
{
    public class UserService : ConnectionHelper
    {
        EF.DesignExplorerEntities db = null;
        public UserService()
        {
            db = new EF.DesignExplorerEntities(EntityConnectionString);
        }
        public UserService(ObjectContext context)
        {
            db = context as EF.DesignExplorerEntities;
        }
